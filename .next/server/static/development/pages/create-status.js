...
var _jsxFileName = "D:\\workspaces\\mydaystatus - Usando Next js\\pages\\create-status.js";
...
const CreateStatus = () => {
  ...
  const salve = async () => {
    await axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/salve-status', dados);
  };
...
module.exports = __webpack_require__(/*! D:\workspaces\mydaystatus - Usando Next js\pages\create-status.js */"./pages/create-status.js");
